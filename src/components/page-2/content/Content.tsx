    ...
    <>
      ...
      <main className="">
        <div className="h-screen overflow-hidden bg-blue-300 text-4xl font-bold text-white/80">
          ...
          >
            <div className="absolute left-1/2 top-[24%] -translate-x-1/2 -translate-y-1/2 text-center  text-[#1b6d3f]">
        ...
        <div className="relative h-screen bg-[#d3d23c] text-4xl font-bold text-white/80"></div>
      </main>
    </>
  );
};
